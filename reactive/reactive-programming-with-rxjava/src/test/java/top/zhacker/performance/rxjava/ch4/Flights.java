package top.zhacker.performance.rxjava.ch4;
...
public class Flights {
	...
	public void sample_49() throws Exception {
		...
		Observable.zip(
				Observable.defer(()-> Observable.just(lookupFlight("FNO"))),
				Observable.defer(()-> Observable.just(findPassenger(42))),
				this::bookTicket
	...
	public void sample_76() throws Exception {
		...
		Observable.zip(
				Observable.defer(()-> Observable.just(lookupFlight("FNO"))).subscribeOn(Schedulers.io()),
				Observable.defer(()-> Observable.just(findPassenger(42))).subscribeOn(Schedulers.io()),
				this::rxBookTicket
		).flatMap(t -> t); //?
	...
	public void sample_177() throws Exception {
		...
		Observable.from(tickets)
				.flatMap(ticket -> rxSendEmail(ticket)
						.flatMap(r -> Observable.empty())
						.doOnError(e -> log.warn(""))
						.onErrorReturn(e -> ticket))
